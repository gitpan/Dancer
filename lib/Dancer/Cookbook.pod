# ABSTRACT: Example-driven quick-start to the Dancer web framework
...
A L<before|Dancer/before> filter declares code which should be handled before
...
See also the L<hook|Dancer/hook> hook keyword.
