...
# PODNAME: Dancer2::Manual::Developers
# ABSTRACT: Steps to follow to hack on Dancer2
...
Go to L<https://github.com/PerlDancer2/Dancer2>. Then you can either grab a tarball, or clone read-only, or fork the project.
...
Dancer2 uses Dist::Zilla ( L<http://dzil.org/> ). Dist::Zilla is a program to
...
C<Dist::Zilla>, so that it knows how to build Dancer2. However, in this
...
=head2 Install Dancer2 dependencies
