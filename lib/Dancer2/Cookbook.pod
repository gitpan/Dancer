...
Note that, by default, Dancer2 configures the Template::Toolkit engine to use
...
=head3 TT's WRAPPER directive in Dancer2 (META variables, SETs)
...
Just call  L<debug|Dancer2/debug>, L<warning|Dancer2/warning> or
L<error|Dancer2/error> with your message:
