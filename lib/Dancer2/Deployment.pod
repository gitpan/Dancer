package Dancer2::Deployment;
# ABSTRACT: Common ways to put your Dancer2 app into use
# PODNAME: Dancer2::Deployment
...
Dancer2::Deployment - Common ways to put your Dancer2 app into use

=head1 VERSION

version 2.000001

Dancer2 has been designed to be flexible, and this flexibility extends to your
choices when deploying your Dancer2 app.
...
You can run your Dancer2 app from Apache using the following examples:
